...
if [[ "${RESUKISU_VERSION_CODE:-}" == "35137" || "${RESUKISU_VERSION_CODE:-}" == "35139" || "${RESUKISU_VERSION_CODE:-}" == "35140" || "${RESUKISU_VERSION_CODE:-}" == "35146" || "${RESUKISU_VERSION_CODE:-}" == "35148" || "${RESUKISU_VERSION_CODE:-}" == "35153" || "${RESUKISU_VERSION_CODE:-}" == "35156" ]]; then
  ...
  # 35156 adds Samsung/session-keyring compatibility plus manager/ksud boot-image
  # handling without changing the adapter-transformed kernel/UAPI source anchors.
  ...
  if [[ "${RESUKISU_VERSION_CODE:-}" == "35139" || "${RESUKISU_VERSION_CODE:-}" == "35140" || "${RESUKISU_VERSION_CODE:-}" == "35146" || "${RESUKISU_VERSION_CODE:-}" == "35148" || "${RESUKISU_VERSION_CODE:-}" == "35153" || "${RESUKISU_VERSION_CODE:-}" == "35156" ]]; then
    ...
    case "$TARGET_VERSION" in
      ...
      35156) NEW_PIN='487b32da8e7f3fc56a936b71dc607bc99418925b' ;;
...
PY
  ...
  if [[ "${RESUKISU_VERSION_CODE:-}" == "35146" || "${RESUKISU_VERSION_CODE:-}" == "35148" || "${RESUKISU_VERSION_CODE:-}" == "35153" || "${RESUKISU_VERSION_CODE:-}" == "35156" ]]; then
